...
public interface StarRocksParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link StarRocksParser#listPartitionValueList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitListPartitionValueList(StarRocksParser.ListPartitionValueListContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link StarRocksParser#string_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitString_(StarRocksParser.String_Context ctx);
	/**
