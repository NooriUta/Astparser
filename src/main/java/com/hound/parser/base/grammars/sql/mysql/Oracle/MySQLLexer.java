// Generated from C:/AIDA/Dali4/HOUND/Hound/src/main/resources/grammars/sql/mysql/Oracle/MySQLLexer.g4 by ANTLR 4.13.1
...
public class MySQLLexer extends MySQLLexerBase {
	...
	public static final int
		...
		INVALID_INPUT=818, UNDERSCORE_CHARSET=819, DOLLAR_QUOTED_STRING_TEXT=820, 
		IDENTIFIER=821, NCHAR_TEXT=822, BACK_TICK_QUOTED_ID=823, DOUBLE_QUOTED_TEXT=824, 
		SINGLE_QUOTED_TEXT=825, VERSION_COMMENT_START=826, MYSQL_COMMENT_START=827, 
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		...
		case 362:
			return MASTER_CONNECT_RETRY_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 363:
			return MASTER_DELAY_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 364:
			return MASTER_HOST_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 365:
			return MASTER_LOG_FILE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 366:
			return MASTER_LOG_POS_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 367:
			return MASTER_PASSWORD_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 368:
			return MASTER_PORT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 369:
			return MASTER_RETRY_COUNT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 370:
			return MASTER_SSL_CAPATH_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 371:
			return MASTER_SSL_CA_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 372:
			return MASTER_SSL_CERT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 373:
			return MASTER_SSL_CIPHER_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 374:
		...
		case 376:
			return MASTER_SSL_KEY_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 377:
			return MASTER_SSL_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 378:
			return MASTER_SSL_VERIFY_SERVER_CERT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 379:
			return MASTER_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 380:
			return MASTER_TLS_VERSION_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 381:
			return MASTER_USER_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 382:
			return MASTER_HEARTBEAT_PERIOD_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 653:
			return UDF_RETURNS_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 729:
		...
		case 792:
			return REQUIRE_ROW_FORMAT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 793:
			return PASSWORD_LOCK_TIME_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 794:
			return FAILED_LOGIN_ATTEMPTS_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 795:
			return REQUIRE_TABLE_PRIMARY_KEY_CHECK_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 796:
			return STREAM_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 797:
			return OFF_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 798:
			return RETURNING_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 799:
			return JSON_VALUE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 800:
			return TLS_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 801:
			return ATTRIBUTE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 802:
			return ENGINE_ATTRIBUTE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 803:
			return SECONDARY_ENGINE_ATTRIBUTE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 804:
			return SOURCE_CONNECTION_AUTO_FAILOVER_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 805:
			return ZONE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 806:
			return GRAMMAR_SELECTOR_DERIVED_EXPR_sempred((RuleContext)_localctx, predIndex);
		case 807:
			return REPLICA_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 808:
			return REPLICAS_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 809:
			return ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 810:
			return GET_SOURCE_PUBLIC_KEY_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 811:
			return SOURCE_AUTO_POSITION_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 812:
			return SOURCE_BIND_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 813:
			return SOURCE_COMPRESSION_ALGORITHM_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 814:
			return SOURCE_CONNECT_RETRY_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 815:
			return SOURCE_DELAY_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 816:
			return SOURCE_HEARTBEAT_PERIOD_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 817:
			return SOURCE_HOST_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 818:
			return SOURCE_LOG_FILE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 819:
			return SOURCE_LOG_POS_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 820:
			return SOURCE_PASSWORD_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 821:
			return SOURCE_PORT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 822:
			return SOURCE_PUBLIC_KEY_PATH_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 823:
			return SOURCE_RETRY_COUNT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 824:
			return SOURCE_SSL_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 825:
			return SOURCE_SSL_CA_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 826:
			return SOURCE_SSL_CAPATH_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 827:
			return SOURCE_SSL_CERT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 828:
			return SOURCE_SSL_CIPHER_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 829:
			return SOURCE_SSL_CRL_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 830:
			return SOURCE_SSL_CRLPATH_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 831:
			return SOURCE_SSL_KEY_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 832:
			return SOURCE_SSL_VERIFY_SERVER_CERT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 833:
			return SOURCE_TLS_CIPHERSUITES_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 834:
			return SOURCE_TLS_VERSION_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 835:
			return SOURCE_USER_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 836:
			return SOURCE_ZSTD_COMPRESSION_LEVEL_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 837:
			return ST_COLLECT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 838:
			return KEYRING_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 839:
			return AUTHENTICATION_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 840:
			return FACTOR_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 841:
			return FINISH_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 842:
			return INITIATE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 843:
			return REGISTRATION_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 844:
			return UNREGISTER_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 845:
			return INITIAL_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 846:
			return CHALLENGE_RESPONSE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 847:
			return GTID_ONLY_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 848:
			return INTERSECT_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 849:
			return BULK_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 850:
			return URL_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 851:
			return GENERATE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 852:
			return PARSE_TREE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 853:
			return LOG_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 854:
			return GTIDS_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 855:
			return PARALLEL_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 856:
			return S3_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 857:
			return QUALIFY_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 858:
			return AUTO_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 859:
			return MANUAL_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 860:
			return BERNOULLI_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 861:
			return TABLESAMPLE_SYMBOL_sempred((RuleContext)_localctx, predIndex);
		case 878:
			return DOLLAR_QUOTED_STRING_TEXT_sempred((RuleContext)_localctx, predIndex);
		case 884:
