...
public interface AthenaParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitTable_row_format_field_identifier(AthenaParser.Table_row_format_field_identifierContext ctx);
	/**
	 * Visit a parse tree produced by {@link AthenaParser#table_row_format_coll_items_identifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTable_row_format_coll_items_identifier(AthenaParser.Table_row_format_coll_items_identifierContext ctx);
	/**
	 * Visit a parse tree produced by {@link AthenaParser#table_row_format_map_keys_identifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTable_row_format_map_keys_identifier(AthenaParser.Table_row_format_map_keys_identifierContext ctx);
	/**
	 * Visit a parse tree produced by {@link AthenaParser#table_row_format_lines_identifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTable_row_format_lines_identifier(AthenaParser.Table_row_format_lines_identifierContext ctx);
	/**
