...
public interface AthenaParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterTable_row_format_field_identifier(AthenaParser.Table_row_format_field_identifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link AthenaParser#table_row_format_field_identifier}.
	 * @param ctx the parse tree
	 */
	void exitTable_row_format_field_identifier(AthenaParser.Table_row_format_field_identifierContext ctx);
	/**
	 * Enter a parse tree produced by {@link AthenaParser#table_row_format_coll_items_identifier}.
	 * @param ctx the parse tree
	 */
	void enterTable_row_format_coll_items_identifier(AthenaParser.Table_row_format_coll_items_identifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link AthenaParser#table_row_format_coll_items_identifier}.
	 * @param ctx the parse tree
	 */
	void exitTable_row_format_coll_items_identifier(AthenaParser.Table_row_format_coll_items_identifierContext ctx);
	/**
	 * Enter a parse tree produced by {@link AthenaParser#table_row_format_map_keys_identifier}.
	 * @param ctx the parse tree
	 */
	void enterTable_row_format_map_keys_identifier(AthenaParser.Table_row_format_map_keys_identifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link AthenaParser#table_row_format_map_keys_identifier}.
	 * @param ctx the parse tree
	 */
	void exitTable_row_format_map_keys_identifier(AthenaParser.Table_row_format_map_keys_identifierContext ctx);
	/**
	 * Enter a parse tree produced by {@link AthenaParser#table_row_format_lines_identifier}.
	 * @param ctx the parse tree
	 */
	void enterTable_row_format_lines_identifier(AthenaParser.Table_row_format_lines_identifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link AthenaParser#table_row_format_lines_identifier}.
	 * @param ctx the parse tree
	 */
	void exitTable_row_format_lines_identifier(AthenaParser.Table_row_format_lines_identifierContext ctx);
	/**
